...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body onload="window.print()">
        ...
        <?php
        $consultaDatoMesaEntrada = obtenerDenunciaPorId($idMesaEntrada);
                ...
                if (!is_null($datoMesaEntrada['IdColegiado'])) {
                    ...
                    if (!$consultaDatoColegiado) {
                        ...
                        if ($consultaDatoColegiado->num_rows == 0) {
                            ...
                            ?>
                            <br/>
                            <h3 style='text-align:center;'>Denuncia de <?php echo utf8_encode($datoMesaEntrada['NombreTipoDenuncia']) ?></h3>
                            <br/>
                            <?php
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td><?php echo utf8_encode($datoMesaEntrada['Observaciones']); ?></td>
                                </tr>
                            </table>
                            <?php
                        }
