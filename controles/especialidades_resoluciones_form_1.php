            ...
            <div class="panel-body">
                ...
                ?>
                    <form id="formElecciones" name="formResolucion" method="POST" onSubmit="" action="datosResoluciones\abm_resolucion.php">
                        ...
                        <?php
                        if ($accion == 1) {
                        $resMesaEntradaEspecialista = obtenerMesaEntradaEspecialistaParaResolucion($tipoResolucion);
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $row['tipoEspecialista']; ?></td>
                                            <td style="text-align: center;">
                                                <a href="especialidades_resoluciones_matricula_form.php?idResolucion=<?php echo $idResolucion; ?>&estado=<?php echo $estadoResoluciones; ?>&accion=1&anio=<?php echo $anioResoluciones ?>" class="btn btn-success btn-lg">Agregar</a>
