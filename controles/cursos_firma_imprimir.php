...
require_once ('../dataAccess/cursosAsistentesLogic.php');
...
class MYPDF extends TCPDF 
{
        ...
        public function Header() 
        {
                ...
                // Title
                $this->Cell(0, 15, 'Listado de Asistentes al curso de Ingles', 0, false, 'C', 0, '', 0, false, 'M', 'M');
        }
...
$html='';
$resConsejeros = obtenerAsistentesCurso(315);
//var_dump($resConsejeros); exit;
if ($resConsejeros['estado']){
    ...
    foreach ($resConsejeros['datos'] as $dato){
        ...
        if ($resArchivos['estado'] && isset($resArchivos['datos'])){
            ...
            $foto = fopen ("ftp://webcolmed:web.2017@192.168.2.50:21/Firmas/".$fileFoto, "rb");
            if (!$foto) {
            ...
            $html .= '<div width="100"><img src="data:image/bmp;base64,'.$fotoVer.'" WIDTH="100" HEIGHT="60" />'
                    . ' - '.$apellidoNombre.'</div><br />';
        }
    }
    //$html .= "</table>";
} else {
